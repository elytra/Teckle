...
/**
 * Holds world network assistants for different types.
 */
public interface IWorldNetworkAssistantHolder {
     ...
     */
    @Nullable
    <T extends INBTSerializable> IWorldNetworkAssistant<T> getAssistant(@Nonnull Class<T> type);
     ...
     */
    @Nonnull
    <T extends INBTSerializable> IWorldNetworkAssistant<T> addAssistant(@Nonnull Class<T> type, @Nonnull IWorldNetworkAssistant<T> assistant);
}
